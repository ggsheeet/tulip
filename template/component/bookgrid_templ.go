...
func BookGrid(books []database.Book) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if len(books) == 0 {
			...
			for _, book := range books {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `template/component/bookgrid.templ`, Line: 53, Col: 48}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `template/component/bookgrid.templ`, Line: 57, Col: 44}
				}
				...
				if book.CoverType == "PDF" {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `template/component/bookgrid.templ`, Line: 59, Col: 52}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `template/component/bookgrid.templ`, Line: 61, Col: 58}
					}
				...
				_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</div><div class=\"card_price_qty\"><h5>$")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `template/component/bookgrid.templ`, Line: 65, Col: 58}
				}
				...
				templ_7745c5c3_Var7, templ_7745c5c3_Err = templ.JoinStringErrs(formatID(book.ID))
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `template/component/bookgrid.templ`, Line: 67, Col: 85}
				}
				...
				templ_7745c5c3_Var8, templ_7745c5c3_Err = templ.JoinStringErrs("qty-" + formatID(book.ID))
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `template/component/bookgrid.templ`, Line: 68, Col: 66}
				}
				...
				templ_7745c5c3_Var9, templ_7745c5c3_Err = templ.JoinStringErrs(formatID(book.ID))
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `template/component/bookgrid.templ`, Line: 69, Col: 85}
				}
				...
				var templ_7745c5c3_Var10 templ.SafeURL = templ.URL(fmt.Sprintf("/book?id=%d&category=%d", book.ID, book.CategoryID))
