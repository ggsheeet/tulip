...
func BookFilter(bcategories []database.BCategory) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</div></fieldset></div><div class=\"filter_group\"><fieldset><legend class=\"group_name\">Orden</legend><div class=\"group_options\"><div class=\"option\"><input type=\"radio\" id=\"expensive\" class=\"checkable\" name=\"order\" value=\"expensive\"> <label for=\"expensive\">Mayor Precio</label></div><div class=\"option\"><input type=\"radio\" id=\"cheap\" class=\"checkable\" name=\"order\" value=\"cheap\"> <label for=\"cheap\">Menor Precio</label></div><div class=\"option\"><input type=\"radio\" id=\"selling\" class=\"checkable\" name=\"order\" value=\"selling\"> <label for=\"selling\">Más Vendido</label></div></div></fieldset></div></form><button id=\"clearCheckBtn\" hx-get=\"/store?clear=true\" hx-trigger=\"click\" hx-target=\"#books\" hx-swap=\"outerHTML\" class=\"disabled\">Limpiar</button></div></aside>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return templ_7745c5c3_Err
